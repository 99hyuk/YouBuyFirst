...
const topBrief = {
  headline: 'HBM 세 글자 붙었다고 실적도 복사될 거라 믿는 건 양심 없는 주문임',
  summary:
    '반도체 업황 회복 기대 · HBM 수요 뉴스 · 가격 +1.24% · 거래량 18.4M · 15분 지연 시세 기준',
  mood: '오늘의 한줄평',
  note:
    '최근 시황은 반도체 쪽으로 바람이 부는 중입니다. 근데 뉴스가 실적표 대신 출근해주는 건 아니고, 숫자 안 찍히면 기대감은 그냥 예쁜 포장지입니다.',
  scoreLine: '시황 점수 77점 · 기대감 ★★★★☆ · 실적표 없으면 행복회로 압수',
