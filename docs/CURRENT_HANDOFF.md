...
- front는 `front/`의 Vue 3 + Vite + TypeScript mock 와이어프레임 shell입니다. 브라우저 QA에서 `favicon.ico` 404를 정리했고, 대시보드 정본은 `docs/workstreams/front/WIREFRAME_HANDOFF.md`, Stitch 프롬프트는 `docs/workstreams/front/STITCH_DASHBOARD_PROMPT.md`입니다.
