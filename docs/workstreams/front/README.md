...
4. 금융 차트는 축, 범례, 선 두께, 색 대비를 정돈해 PPT처럼 보이지 않게 합니다.
5. 커뮤니티 반응, 뉴스/공시, 가격 변화가 왜 같이 움직였는지 짧게 연결합니다.
6. 외부 글 제목이 아닌 서비스 문구에서는 `추천`, `사라`, `팔아라`, `수익 보장`, `진입`, `시그널 확정` 같은 투자 자문형 표현을 쓰지 않습니다.
