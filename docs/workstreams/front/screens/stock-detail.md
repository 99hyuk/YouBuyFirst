...
- loading: 팩트폭격 패널, quote snapshot, TradingView chart shell skeleton을 먼저 보여준다.
...
- 2026-05-19: 메인 가격 차트를 TradingView widget으로 분리하고, 현재가/등락률/거래량/asOf/stale은 별도 quote snapshot API 후보로 명시.
